...
def load_checkpoint(
    ...
    for key in ignore_keys:
        if key in state_dict:
            ignored_state_dict[key] = state_dict[key]
            del state_dict[key]
    ...
    # restore ignored keys
    for key in ignore_keys:
        state_dict[key] = ignored_state_dict[key]
        del ignored_state_dict[key]
    ...
    if optimizer is not None:
        ...
        return state_dict, epoch, missing, unexpect, rng_state
